    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden selection:bg-primary selection:text-primary-foreground">
        ...
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-2xl font-heading font-bold text-white tracking-tighter">
              JBS <span className="text-primary">COMERCIALIZAÇÃO</span>
            </span>
          </div>
          ...
          <Button variant="outline" className="hidden md:flex border-primary/50 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300" asChild>
        ...
        <div className="container mx-auto px-4 z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="h-14 px-8 text-base font-semibold bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_0_30px_rgba(212,175,55,0.2)] hover:shadow-[0_0_40px_rgba(212,175,55,0.4)] transition-all duration-300" asChild>
                <a href="#showroom">Explorar Estoque</a>
              </Button>
              <Button size="lg" variant="outline" className="h-14 px-8 text-base font-semibold border-white/20 hover:bg-white/5 transition-all duration-300" asChild>
      ...
      <section className="py-20 relative z-10 bg-card/30 border-y border-white/5">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { icon: ShieldCheck, title: "Garantia de Procedência", desc: "Veículos inspecionados" },
              { icon: Award, title: "Qualidade Premium", desc: "Padrão showroom" },
              { icon: Star, title: "Avaliação 5 Estrelas", desc: "Satisfação máxima" },
              { icon: Clock, title: "Atendimento Ágil", desc: "Consultoria especializada" }
            ].map((feature, idx) => (
              <motion.div key={idx} variants={fadeIn} className="flex flex-col items-center text-center group">
                <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center mb-4 text-primary group-hover:scale-110 group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-500">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-8 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                <span className="text-primary font-semibold tracking-wider text-sm uppercase mb-2 block">Sofisticação</span>
      ...
      <section id="sobre" className="py-24 bg-card/40 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-primary/5 rounded-l-full blur-3xl -z-10 transform translate-x-1/2" />
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-4 bg-background/80 border border-white/10 px-8 py-4 rounded-full"
            >
              <div className="flex gap-1">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl font-bold font-heading text-white mb-6">Venha nos Visitar</h2>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-6 group">
                  <div className="w-14 h-14 rounded-full bg-card border border-white/10 flex items-center justify-center shrink-0 group-hover:border-primary transition-colors">
                ...
                <div className="flex items-start gap-6 group">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/5521980921622" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary transition-colors text-lg">
                      (21) 98092-1622
                    </a>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="https://wa.me/5521980921622" target="_blank" rel="noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            ...
            <p>
              Desenvolvido por <a href="mailto:cscomrj02@gmail.com" className="text-white hover:text-primary transition-colors font-medium">CS Studios</a>
            </p>
          </div>
        </div>
      </footer>
